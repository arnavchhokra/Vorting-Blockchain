    ...
    <Box>
      {loading ? (
        ...
        <div style={{display:'flex', alignItems:'center', justifyContent:'center', paddingTop:'100px'}}>
          <div style={{display:'flex', flexDirection:'column', marginLeft:'200px', width:'120%'}}>
            <h1 style={{color:'blue', fontSize:'50px'}}>WELCOME</h1>
            <p style={{fontSize:'25px'}}>Electronic voting in polling stations is in place in some of the world’s largest democracies, and Internet voting is used in some, initially mainly small and historically conflict-free, countries. Many countries are currently considering introducing e-voting systems with the aim of improving various aspects of the electoral process.</p>
          </div>
          <div style={{width:'50%'}}>
          <Grid container sx={{ mt: 0 }} >
            <Grid item xs={12}>
              <Typography align="center" variant="h6" color="textSecondary" style={{marginBottom:'20px'}} >
                ELECTION STATUS :{" "}
            ...
            <Grid item xs={12}>
              <Typography align="center" variant="h6" style={{marginTop:'30px'}}>
